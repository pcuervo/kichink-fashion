		...
		<div id="item-container" class="[ container ]">
			...
			<div class="[ main ]">
				...
				<section class="[ product__info ]">
					<div class="[ wrapper ]">
						<div class="[ row ]">
							<ul class="[ rrssb-buttons ] [ margin-bottom ]">
					...
					<div class="[ wrapper ]">
						...
						<article class="[ product__buy ][ margin-bottom ][ text-center ]">
						...
						<article class="[ text-center ][ margin-bottom ]">
							<a href="#" class="[ inline-block ][ button button--dark ]">Ver productos relacionados</a>
						</article>
					</div><!-- wrapper -->
